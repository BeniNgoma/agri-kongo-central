...
export default function Activites() {
  ...
  return (
    <section id="activites" className="bg-green-deep py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/60 max-w-2xl mx-auto text-sm sm:text-base">
            ...
            compétitivité agricole à Boko et Mbanza-Ngungu.
          </p>
        </motion.div>
            ...
            {activities.map((act, i) => {
              ...
              return (
                <motion.button
                  ...
                  onClick={() => setActive(i)}
                  whileTap={{ scale: 0.97 }}
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all whitespace-nowrap lg:whitespace-normal min-w-max lg:min-w-0 flex-shrink-0 lg:flex-shrink ${
                    active === i
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="p-5 sm:p-8">
                  ...
                  <p className="text-white/70 leading-relaxed mb-5 sm:mb-6 text-sm sm:text-base">
