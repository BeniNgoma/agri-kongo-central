  ...
  return (
    <section id="activites" className="bg-green-deep py-16 sm:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-playfair text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
            Actions Concretes sur le{" "}
            <span className="text-gradient">Terrain</span>
          </h2>
          <p className="text-white/60 max-w-2xl mx-auto text-sm sm:text-base">
            Des actions complementaires visant a renforcer durablement la productivite, l organisation et
            la competitivite agricole a Boko et Mbanza-Ngungu.
          </p>
        </motion.div>
      </div>

      {/* Marquee strip — droite vers gauche */}
      <div
      ...
      >
        ...
        {/* Track — cartes dupliquees pour boucle sans couture */}
        <div
            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  ...
                  <div className="flex items-center gap-1.5 text-gold text-[11px] font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span>Voir les details</span>
                    <span className="text-xs">&#8594;</span>
                  </div>
                </div>
                {/* Gold border on hover */}
                <div className="absolute inset-0 rounded-2xl border border-transparent group-hover:border-gold/50 transition-colors duration-300" />
              </motion.button>
            );
          })}
        </div>
